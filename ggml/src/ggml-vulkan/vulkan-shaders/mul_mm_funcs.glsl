...
void load_a_to_shmem(const uint pos_a, const uint row, const uint col, const uint idx_m, const uint block, const uint end_k) {
    ...
    if (MmTypeA == GGML_TYPE_Q4_0) {
        ...
        const float d = float(a_q5_0_p16.data[ib].d);
        const uint uint_qh = uint(a_q5_0_p16.data[ib].qh[1]) << 16 | uint(a_q5_0_p16.data[ib].qh[0]);
        const ivec2 qh0 = ivec2(((uint_qh >> 2*iqs) << 4) & 0x10, (uint_qh >> (2*iqs + 12)) & 0x10);
        const ivec2 qh1 = ivec2(((uint_qh >> (2*iqs + 1)) << 4) & 0x10, (uint_qh >> (2*iqs + 13)) & 0x10);

        const uint vui = uint(a_q5_0_p16.data[ib].qs[iqs]);
        ...
        const vec2 dm = vec2(a_q5_1_p32.data[ib].dm);
        const uint uint_qh = a_q5_1_p32.data[ib].qh;
        ...
        const uint vui = a_q5_1_p32.data[ib].qs[iqs];
        ...
        const float d = float(a_q1_0.data[ib].d);
        const uint bits = uint(a_q1_0.data[ib].qs[iqs]);
        ...
        const FLOAT_TYPE d = FLOAT_TYPE(a_q2_0.data[ib].d);
        const uint bits = uint(a_q2_0.data[ib].qs[iqs]);
        ...
        const vec2 loadd = vec2(a_q5_k.data[ib].dm);

        const uvec3 scales = uvec3(a_q5_k_p32.data[ib].scales[0],
                                    a_q5_k_p32.data[ib].scales[1],
                                    a_q5_k_p32.data[ib].scales[2]);
        const uint scalesoffs = (is & 3) * 8;
