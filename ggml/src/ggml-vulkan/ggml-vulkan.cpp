    ...
    for (uint32_t w = 0; w < DMMV_WG_SIZE_COUNT; ++w) {
        ...
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ...
            if (device->integer_dot_product) {
                ...
                const uint32_t subgroup_size_int16 = std::max(subgroup_size_int, 16u);
                const uint32_t wg_size_subgroup_int16 = (w == DMMV_WG_SIZE_SUBGROUP) ? subgroup_size_int16 : (subgroup_size_int16 * 4);
        ...
        if (device->integer_dot_product) {
            ...
            if (ggml_vk_iqk_dp4a_support(device)) {
                const uint32_t iqk_subgroup_size_int = subgroup_size_int16;
                const uint32_t iqk_wg_size_subgroup_int = wg_size_subgroup_int16;
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ2_K], "mul_mat_vec_id_iq2_k_q8_1_f32", arr_dmmv_id_iq2_k_q8_1_f32_len[reduc], arr_dmmv_id_iq2_k_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ3_K], "mul_mat_vec_id_iq3_k_q8_1_f32", arr_dmmv_id_iq3_k_q8_1_f32_len[reduc], arr_dmmv_id_iq3_k_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ...
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ5_K], "mul_mat_vec_id_iq5_k_q8_1_f32", arr_dmmv_id_iq5_k_q8_1_f32_len[reduc], arr_dmmv_id_iq5_k_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ...
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ4_KSS], "mul_mat_vec_id_iq4_kss_q8_1_f32", arr_dmmv_id_iq4_kss_q8_1_f32_len[reduc], arr_dmmv_id_iq4_kss_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ2_KS], "mul_mat_vec_id_iq2_ks_q8_1_f32", arr_dmmv_id_iq2_ks_q8_1_f32_len[reduc], arr_dmmv_id_iq2_ks_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ3_KS], "mul_mat_vec_id_iq3_ks_q8_1_f32", arr_dmmv_id_iq3_ks_q8_1_f32_len[reduc], arr_dmmv_id_iq3_ks_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ4_KS], "mul_mat_vec_id_iq4_ks_q8_1_f32", arr_dmmv_id_iq4_ks_q8_1_f32_len[reduc], arr_dmmv_id_iq4_ks_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ5_KS], "mul_mat_vec_id_iq5_ks_q8_1_f32", arr_dmmv_id_iq5_ks_q8_1_f32_len[reduc], arr_dmmv_id_iq5_ks_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ...
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ1_KT], "mul_mat_vec_id_iq1_kt_q8_1_f32", arr_dmmv_id_iq1_kt_q8_1_f32_len[reduc], arr_dmmv_id_iq1_kt_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ...
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ3_KT], "mul_mat_vec_id_iq3_kt_q8_1_f32", arr_dmmv_id_iq3_kt_q8_1_f32_len[reduc], arr_dmmv_id_iq3_kt_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_IQ4_KT], "mul_mat_vec_id_iq4_kt_q8_1_f32", arr_dmmv_id_iq4_kt_q8_1_f32_len[reduc], arr_dmmv_id_iq4_kt_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_id(rm_kq_int), 1, 1}, {iqk_wg_size_subgroup_int, rm_id(rm_kq_int)}, 1, true, use_subgroups, iqk_subgroup_size_int);
            }
        }
#endif // GGML_VULKAN_INTEGER_DOT_GLSLC_SUPPORT
    }
...
static vk_pipeline ggml_vk_get_dequantize_mul_mat_vec(ggml_backend_vk_context * ctx, ggml_type a_type, ggml_type b_type, uint32_t num_cols, uint32_t m, uint32_t k) {
    ...
    if (b_type == GGML_TYPE_Q8_1) {
        ...
        if (ggml_vk_is_iqk_type(a_type) && uselarge) {
            dmmv_wg = DMMV_WG_SIZE_LARGE;
        } else if (ctx->device->vendor_id == VK_VENDOR_ID_INTEL) {
            dmmv_wg = DMMV_WG_SIZE_SUBGROUP;
        }
        if (logged_types.insert(a_type).second)
            printf("[%c]get dmmv[%s], wg[%u]\n", uselarge ? 'Y' : 'N', ggml_get_type_traits(a_type)->type_name, dmmv_wg);
...
static vk_pipeline ggml_vk_get_dequantize_mul_mat_vec_id(ggml_backend_vk_context * ctx, ggml_type a_type, ggml_type b_type, uint32_t m, uint32_t k) {
    ...
    if (b_type == GGML_TYPE_Q8_1) {
        ...
        if (logged_types.insert(a_type + 1024).second)
            printf("[%c]get dmmv_id[%s], wg[%u]\n", uselarge ? 'Y' : 'N', ggml_get_type_traits(a_type)->type_name, dmmv_wg);
