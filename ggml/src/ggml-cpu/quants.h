...
void quantize_row_q8_0_x4_generic(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k);
void quantize_row_q8_1_x4_generic(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k);
void quantize_row_q8_2_x4_generic(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k);
