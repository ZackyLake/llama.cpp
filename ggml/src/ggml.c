...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q8_K128] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q8_K128,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q8_K128_ref,
    },
    [GGML_TYPE_BF16] = {
        .type_name                = "bf16",
        .blck_size                = 1,
    ...
    [GGML_TYPE_Q8_0_X4] = {
        ...
        .type_size                = sizeof(block_q8_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q8_0_x4,
        .from_float_ref           = quantize_row_q8_0_x4_ref,
    },
    [GGML_TYPE_Q8_1_X4] = {
        .type_name                = "q8_1_x4",
        .blck_size                = QK8_1,
        .type_size                = sizeof(block_q8_1),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q8_1_x4,
        .from_float_ref           = quantize_row_q8_1_x4_ref,
    },
    [GGML_TYPE_Q8_2_X4] = {
        .type_name                = "q8_2_x4",
        .blck_size                = QK8_2,
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q8_2_x4,
        .from_float_ref           = quantize_row_q8_2_x4_ref,
    },
    [GGML_TYPE_IQ2_K] = {
        .type_name                = "iq2_k",
        .blck_size                = QK_K,
