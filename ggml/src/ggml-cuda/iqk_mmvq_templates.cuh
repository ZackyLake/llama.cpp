...
#pragma unroll
                ...
                tmp[j] += vec_dot_q_cuda((const void *)((const char *)vx + row0*row_size),
                    &y[j*blocks_per_col_y + kby], kbx, kqs);
            }
        }
    }
...
#pragma unroll
                ...
                tmp_u[j] += vec_dot_q_cuda((const void *)((const char *)vup + row0*row_size),
                    &y[j*blocks_per_col_y + kby], kbx, kqs);
                tmp_g[j] += vec_dot_q_cuda((const void *)((const char *)vgate + row0*row_size),
                    &y[j*blocks_per_col_y + kby], kbx, kqs);
            }
        }
    }
