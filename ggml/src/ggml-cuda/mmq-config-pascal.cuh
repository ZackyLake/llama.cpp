...
#define IQK_CASES(TYPE, LAYOUT) \
    CASE(TYPE, 256, 2, 64,   8, LAYOUT, MMQ_ITER_K, false, true);  \
    CASE(TYPE, 256, 2, 64,  16, LAYOUT, MMQ_ITER_K, false, true);  \
    CASE(TYPE, 256, 2, 64,  32, LAYOUT, MMQ_ITER_K, false, true);  \
    CASE(TYPE, 256, 2, 64,  64, LAYOUT, MMQ_ITER_K, false, true);  \
    CASE(TYPE, 256, 2, 64,   8, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(TYPE, 256, 2, 64,  16, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(TYPE, 256, 2, 64,  24, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(TYPE, 256, 2, 64,  32, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(TYPE, 256, 2, 64,  40, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(TYPE, 256, 2, 64,  48, LAYOUT, MMQ_ITER_K, false, false); \
    CASE(TYPE, 256, 2, 64,  64, LAYOUT, MMQ_ITER_K, false, false)
